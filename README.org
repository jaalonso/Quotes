...
+ A programming language is low level when its programs require attention to the
  irrelevant.
  + Un lenguaje de programación es de bajo nivel cuando sus programas requieren
    atención a lo irrelevante.

+ Fools ignore complexity. Pragmatists suffer it. Some can avoid it. Geniuses
  remove it.
  + Los tontos ignoran la complejidad. Los pragmáticos lo sufren. Algunos pueden
    evitarlo. Los genios lo quitan.
...
+ If you find that you're spending almost all your time on theory, start turning
  ...
  + Si descubre que dedica casi todo su tiempo a la teoría, comience a prestar
    atención a las cosas prácticas; mejorará tus teorías. Si descubre que dedica
    casi todo su tiempo a la práctica, comience a prestar atención a las cosas
    teóricas; mejorará tu práctica.
...
+ Besides a mathematical inclination, an exceptionally good mastery of one's
  ...
  + Además de una inclinación matemática, un dominio excepcionalmente bueno de
    la lengua materna es el activo más vital de un programador competente.
...
+ Simplicity is a great virtue but it requires hard work to achieve it and
  ...
  better.
  + La simplicidad es una gran virtud pero requiere mucho trabajo para
    alcanzarla y educación para apreciarla. Y para empeorar las cosas: la
    complejidad vende mejor.
